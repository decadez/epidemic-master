...
export const routes: IRoute[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: 'menu.health.abnormal-declaration',
        key: 'health/abnormal-declaration',
      },
      {
        name: 'menu.health.history',
        key: 'health/history',
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'menu.boss.action',
        key: 'boss/action',
      },
      {
        name: 'menu.boss.manage',
        key: 'boss/manage',
      },
    ],
  },
