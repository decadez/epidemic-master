const i18n = {
  'en-US': {
    ...
    'menu.dashboard': 'Community Dashboard',
    'menu.notice': 'Community Notice',
    'menu.notice.create': 'Notice Create',
    'menu.notice.list': 'Notice List',
    'menu.message': 'Community Message',
    'menu.message.list': 'Message List',
    'menu.health': 'Sign In Healthily',
    'menu.health.history': 'Healthily History',
    'menu.health.abnormal-declaration': 'Abnormal Declaration',
    'menu.list': 'List',
    'menu.result': 'Result',
  ...
  'zh-CN': {
    'menu.dashboard': '社区看盘',
    'menu.notice': '社区公告',
    'menu.notice.create': '公告创建',
    'menu.notice.list': '公告列表',
    'menu.message': '社区留言',
    'menu.message.list': '留言列表',
    'menu.health': '健康打卡',
    'menu.health.history': '打卡历史',
    'menu.health.abnormal-declaration': '异常申报',
    'menu.list': '列表页',
    'menu.result': '结果页',
    'menu.exception': '异常页',
    'menu.form': '表单页',
    ...
    'menu.boss': '权限管理',
    'menu.boss.user': '用户权限',
    'menu.boss.action': '操作权限',
    'menu.boss.manage': '全表管理',
    'menu.exception.403': '403',
    'menu.exception.404': '404',
    'menu.exception.500': '500',
