const i18n = {
  'en-US': {
    'login.form.title': 'Login to 社区疫情管理系统',
    'login.form.userName.errMsg': 'Username cannot be empty',
    'login.form.password.errMsg': 'Password cannot be empty',
    'login.form.login.errMsg': 'Login failed, please check your enter info',
  ...
  'zh-CN': {
    'login.form.title': '登录 社区疫情管理系统',
    'login.form.userName.errMsg': '用户名不能为空',
    'login.form.password.errMsg': '密码不能为空',
    'login.form.login.errMsg': '登陆失败，请检查登陆信息',
